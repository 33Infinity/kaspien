<?php
    ...
    class BaseDAO
    {
        ...
        protected function Select($tableName)
        {
            $sql = "";
        ...
        protected function SelectRaw($aQuery)
        {
            $result = mysqli_query($this->con, $aQuery);
            return mysqli_fetch_all($result, MYSQLI_ASSOC);
        }

        protected function Insert($columns, $values, $tableName)
        {
            $columnSql = "";
            $valueSql = "";
        ...
        protected function Update($columns, $columnValues, $tableName)
        {
            $sql = "";
            $setSql = "";
            $filterSql = "";
        ...
        protected function InsertRaw($sql)
        {
            if ($stmt = $this->con->prepare($sql)) 
            {
                $stmt->execute();
        ...
        protected function UpdateRaw($sql)
        {
            if ($stmt = $this->con->prepare($sql)) 
            {
                $stmt->execute();
